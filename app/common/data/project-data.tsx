...
export function countProjects(projects: any[]) {
  ...
  const siteBuilderCount = projects.filter(
...
export const projects = [
  {
    ...
    short_description:
      "ZEN Experience is a website created for a local business built using Shopify.",
    description:
      "ZEN Experience is a website created for a local business, aimed at providing an elegant and calming digital presence that reflects the brand’s philosophy. Built using WordPress, the site showcases the business’s offerings, features a modern and clean design, and ensures a smooth user experience across devices. The project involved customizing WordPress themes and integrating various plugins to meet the client's needs, with a focus on aesthetics and user engagement.",
    image:
      "https://zenexperience.com/cdn/shop/files/Logo-1-with-TM_ee123a29-2576-4031-923f-45d5c3e4897e.png?v=1741793449&width=360",
  ...
  },
  {
    ...
    short_description:
      "A cross-platform desktop application built with Angular and Electron, extending the MyTaskOwl ecosystem.",
    description:
  ...
  },
  {
    ...
    title: "Dev Portfolio",
    short_description:
      "My personal portfolio website built using Next.js, TypeScript, and Tailwind CSS.",
    description:
      "My personal portfolio website built using Next.js, TypeScript, and Tailwind CSS. This project showcases my skills, projects, and experience as a developer. The site is fully responsive and optimized for performance, providing a seamless user experience across devices. I utilized Next.js for server-side rendering and static site generation, ensuring fast load times and SEO optimization. The design is clean and modern, reflecting my personal brand and development philosophy.",
  ...
  },
  {
    ...
    short_description:
      "The MyTaskOwl Admin Panel is built with nextJS using the existing backend of MyTaskOwl (Laravel). The admin panel allows administrators to manage users, view analytics, and configure system settings.",
    description:
      "The MyTaskOwl Admin Panel is built with nextJS using the existing backend of MyTaskOwl (Laravel). The admin panel allows administrators to manage users, view analytics, and configure system settings. I worked on integrating the admin panel with the existing backend APIs, ensuring secure authentication and authorization for admin users. The panel features a clean and intuitive interface, making it easy for administrators to navigate and perform their tasks efficiently.",
    image:
      "https://i0.wp.com/mytaskowl.com/wp-content/uploads/2025/05/cropped-mytaskowl_logo.png?fit=801%2C844&ssl=1",
  ...
  },
  {
    ...
    short_description:
      "A cross-platform companion app for the MyTaskOwl Web platform, built with React Native and Expo.",
    description:
