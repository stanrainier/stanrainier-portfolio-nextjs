...
export default function Contact() {
  ...
  return (
    <div>
      <AnimatedSection>
        <WordRotate
          className="text-5xl font-bold text-center dark:text-amber-50 mb-12"
            ...
            <CardHeader className="flex gap-3">
              <div className="flex flex-col">
                <p className=" text-lg mb-2 lg:text-2xl  text-center sm:text-left">
                  <TextAnimate animation="slideUp">Contact Me!</TextAnimate>
                </p>
                <p className="text-md text-default-500 lg:text-lg  text-center sm:text-left">
                  <TextAnimate animation="slideUp">
                    Feel free to send me a message. Give me feedback, or just
                    say hi!
                  </TextAnimate>
                </p>
              </div>
          ...
          <Card className="max-w-[1400px] w-full ">
            <CardHeader className="flex gap-3">
              <div className="flex flex-col">
                <p className="text-lg mb-2 lg:text-2xl ">
                  {" "}
                  <TextAnimate animation="slideUp">Social Media</TextAnimate>
                </p>
            ...
            <CardBody className="p-8 align-items-center justify-items-center">
              {contactSocialLinks.map((link) => (
                <div
                  key={link.title}
                  className="flex items-center gap-3 mb-4 sm:flex-row flex-col"
                >
                  <Avatar
                    alt={link.title}
                  ...
                  <div className="flex flex-col">
                    <Link
                      className="text-md font-bold hover:text-default-500 duration-300 ease-in-out  text-center sm:text-left"
                      href={link.url}
                    >
                      <TextAnimate animation="slideUp">
                        {link.title}
