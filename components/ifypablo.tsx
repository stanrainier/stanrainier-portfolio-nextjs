      ...
      <AnimatedSection>
        <Card className="flex flex-col md:flex-row items-center gap-6 p-4 sm:p-6 md:p-8 my-4">
          ...
          <div className='flex flex-col'>
            <h1 className={`${lacquer.className} text-3xl sm:text-4xl md:text-6xl text-center md:text-left my-4 md:my-8`}>
              ifypablo
            </h1>
            <span className={`${lacquer.className} text-base sm:text-lg md:text-xl mb-4 sm:mb-6 md:mb-8 text-justify`}>
            ...
            <div className="flex justify-center md:justify-start">
              ...
              >
                <FaSoundcloud size={36} className="sm:!w-10 sm:!h-10" />
                <h1 className={`${lacquer.className} text-lg sm:text-xl md:text-2xl`}>Check out ifypablo</h1>
              </Link>
            </div>
          </div>
        </Card>
      ...
      <AnimatedSection>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
          ...
          <Card className="flex flex-col justify-center items-center gap-4 sm:gap-6 p-4 sm:p-6 my-4">
            <ShineBorder shineColor={["#1703fc", "#fc03f0", "#fc03f0"]} />
            <h1 className={`${lacquer.className} text-2xl sm:text-3xl md:text-4xl`}>Latest Release</h1>
            <div className="w-full">
              ...
              <div className="text-[10px] text-gray-400 truncate mt-1">
                <a href="https://soundcloud.com/ifypablo" target="_blank" rel="noreferrer" className="hover:underline">
                  ifypablo
                </a>{" "} · {" "}
                <a href="https://soundcloud.com/ifypablo/ifypablo-x-slate-di-ko-pa-ma-amin-ft-jdel" target="_blank" rel="noreferrer" className="hover:underline">
          ...
          <Card className="flex flex-col justify-center items-center gap-4 sm:gap-6 p-4 sm:p-6 my-4">
            <ShineBorder shineColor={["#1703fc", "#fc03f0", "#fc03f0"]} />
            <h1 className={`${lacquer.className} text-2xl sm:text-3xl md:text-4xl`}>Latest Mixtape</h1>
            <Link href="https://soundcloud.com/ifypablo/sets/roses-for-amy" className="w-full">
              <Image
                src="/images/r4a.png"
                alt="Stan Rainier D. Salazar"
                width={1000}
